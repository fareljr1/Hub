...
function Blacklib:Window()
    ...
    BlackImage.Image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0Rkz3UQTwjW9KzdpE0g0xdQoY3eyIMfO7XaXPSKeGUU2n7_s&amp;s"
    ...
    spawn(function()
        while task.wait() do
            titlefunc:Refresh("") wait(.2) titlefunc:Refresh("U") wait(.2) titlefunc:Refresh("Uc") wait(.2) titlefunc:Refresh("Uci") wait(.2) titlefunc:Refresh("Ucih") wait(.2) titlefunc:Refresh("Uciha") wait(.2) titlefunc:Refresh("Uciha ") wait(.2) titlefunc:Refresh("Uciha H") wait(.2) titlefunc:Refresh("Uciha Hu") wait(.2) titlefunc:Refresh("Uciha Hub") wait(.9) titlefunc:Refresh("Uciha Hu") wait(.2) titlefunc:Refresh("Uciha H") wait(.2) titlefunc:Refresh("Uciha ") wait(.2) titlefunc:Refresh("Uciha") wait(.2) titlefunc:Refresh("Ucih") wait(.2) titlefunc:Refresh("Uci") wait(.2) titlefunc:Refresh("Uc") wait(.2) titlefunc:Refresh("U") wait(.2) 
 titlefunc:Refresh("") wait(.2) wait(.3)
 titlefunc:Refresh("Uciha Hub") wait(.2) wait(.3)
 titlefunc:Refresh("") wait(.2) wait(.3)
 titlefunc:Refresh("Uciha Hub") wait(.2) wait(.3)
 titlefunc:Refresh("") wait(.2) wait(.3)
        end
